...
@{
    ...
    RequiredModules   = @(@{ModuleName = 'Az.Accounts'},
    ...
    FunctionsToExport = @('Set-SAPSPNSecrets', 'New-SAPSystem', 'New-SAPDeployer', 'New-SAPAutomationRegion', 'New-SAPLibrary', 'New-SAPWorkloadZone', 'Remove-SAPSystem')
